...
1. **ZX матрица** — эмуляция ZX Spectrum 40-клавишной клавиатуры, порт `#FE`.
2. **PS/2 клавиатура** — полная PC-клавиатура через Z84C15 SIO, порты `#18`/`#19`.

DSS (функции `WaitKey`, `ScanKey`) использует комбинацию обоих источников.
