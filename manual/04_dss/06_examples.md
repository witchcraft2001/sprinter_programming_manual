...
main:
        push    ix                  ; IX при входе указывает на буфер аргументов (load-#80)
...
> - Указатель на буфер аргументов передаётся в IX при входе (= load-#80; при load #8100 — #8080), формат: длина + текст.
