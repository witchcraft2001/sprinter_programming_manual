...
| Раздел | Описание |
|--------|---------|
| [5.1 Обзор видео](05_graphics/01_video_overview.md) | VRAM, режимы, основы |
| [5.2 ZX режим](05_graphics/02_zx_mode.md) | 256×192, атрибуты, совместимость |
| [5.3 Режим 320×256](05_graphics/03_mode1_320.md) | 8bpp линейный, основной режим |
| [5.4 Режим 640×512](05_graphics/04_mode2_640.md) | 4bpp для текста и CAD |
